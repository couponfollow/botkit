...
function Slackbot(configuration) {
    ...
    slack_botkit.createWebhookEndpoints = function(webserver, authenticationTokens, verificationToken) {

        if (authenticationTokens && arguments.length > 1 && arguments[1].length) {
