...
function Botkit(configuration) {
    ...
    function Conversation(task, message) {
        ...
        this.handle = function(message, bot) {
        ...
        this.say = function(message, callback) {
            ...
            if (this.isActive()) {
                ...
                if (this.messages.length) {
                    if (typeof(this.messages[0].timestamp) == 'undefined' ||
                        ...
                        if (message.text || message.attachments || message.attachment || message.type) {
